...
if [ "$EUID" -ne 0 ]; then
    ...
    git clone --branch "$SCRIPT_VERSION" --recurse-submodules --single-branch https://github.com/Hermananza/scriptv1.git /root/RustyManager > /dev/null 2>&1 || error_exit "Falha ao clonar RustyManager"
